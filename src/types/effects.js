...
class Effects {
  ...
  /**
    * Applies an effect to the provided image. Please see https://weebyapi.xyz/api/docs#section5 for the available effects.
  ...
  async general(options = {}) {
    try {
      ...
      if (!options.type) throw new TypeError(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("Type parameter is missing. You will need to provide the type of effect to apply.")}`);
      ...
      if (general.includes(options.type)) {
        ...
        throw new TypeError(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("The effect you tried to apply was not found. Make sure it is spelt correctly.")}`);
      }
    } catch (e) {
      throw new Error(e);
    }
  ...
  /**
    * Applies an effect to the provided image that can change the level. Please see https://weebyapi.xyz/api/docs#section5 for the available effects.
    * @param {Object} options - The options that contain the required parameters.
    * @param {string} options.type - The Type of Effect to use.
  ...
  async intensity(options = {}) {
    try {
      ...
      if (typeof options.image !== "string") throw new Error(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("The Image parameter is not a string.")}`);
      if (!options.type) throw new TypeError(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("Type parameter is missing. You will need to provide the type of effect to apply.")}`);
      if (!options.intensity) throw new TypeError(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("Intensity parameter is missing. You will need to provide a number.")}`);
      if (!options.image) throw new TypeError(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("Image parameter is missing. You will need to provide a valid image link.")}`);
  ...
  async resize(options = {}) {
    try {
      ...
      if (typeof options.image !== "string") throw new Error(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("The Image parameter is not a string.")}`);
      if (!options.width) throw new TypeError(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("Width parameter is missing. You will need to provide a number.")}`);
      if (!options.height) throw new TypeError(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("Height parameter is missing. You will need to provide a number.")}`);
      if (!options.image) throw new TypeError(`${chalk.magenta("Weeby-JS")} ${chalk.gray("»")} ${chalk.yellow("Image parameter is missing. You will need to provide a valid image link.")}`);
